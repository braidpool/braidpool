...
pub mod count {
    ...
    pub fn get_type() -> ::capnp::introspect::Type {
        <i32 as ::capnp::introspect::Introspect>::introspect()
    }
}
pub mod exception {
...
pub mod thread_map {
    ...
    pub type MakeThreadParams =
        ::capnp::capability::Params<crate::proxy_capnp::thread_map::make_thread_params::Owned>;
    pub type MakeThreadResults =
        ::capnp::capability::Results<crate::proxy_capnp::thread_map::make_thread_results::Owned>;
    ...
    impl Client {
        pub fn make_thread_request(
            &self,
        ) -> ::capnp::capability::Request<
            crate::proxy_capnp::thread_map::make_thread_params::Owned,
            crate::proxy_capnp::thread_map::make_thread_results::Owned,
        > {
            self.client
    ...
    pub trait Server {
        fn make_thread(
            ...
            ::capnp::capability::Promise::err(::capnp::Error::unimplemented(
                "method thread_map::Server::make_thread not implemented".to_string(),
            ))
        }
    }
...
pub mod thread {
    #![allow(unused_variables)]
    pub type GetNameParams =
        ::capnp::capability::Params<crate::proxy_capnp::thread::get_name_params::Owned>;
    pub type GetNameResults =
        ::capnp::capability::Results<crate::proxy_capnp::thread::get_name_results::Owned>;
    ...
    impl Client {
        pub fn get_name_request(
            &self,
        ) -> ::capnp::capability::Request<
            crate::proxy_capnp::thread::get_name_params::Owned,
            crate::proxy_capnp::thread::get_name_results::Owned,
        > {
            self.client
                .new_call(_private::TYPE_ID, 0, ::core::option::Option::None)
        }
    ...
    pub trait Server {
        fn get_name(
            ...
            ::capnp::capability::Promise::err(::capnp::Error::unimplemented(
                "method thread::Server::get_name not implemented".to_string(),
            ))
        }
    }
    pub struct ServerDispatch<_T> {
