...
pub mod init {
    ...
    pub type ConstructParams =
        ::capnp::capability::Params<crate::init_capnp::init::construct_params::Owned>;
    pub type ConstructResults =
        ::capnp::capability::Results<crate::init_capnp::init::construct_results::Owned>;
    pub type MakeEchoParams =
        ::capnp::capability::Params<crate::init_capnp::init::make_echo_params::Owned>;
    pub type MakeEchoResults =
        ::capnp::capability::Results<crate::init_capnp::init::make_echo_results::Owned>;
    pub type MakeMiningParams =
        ::capnp::capability::Params<crate::init_capnp::init::make_mining_params::Owned>;
    pub type MakeMiningResults =
        ::capnp::capability::Results<crate::init_capnp::init::make_mining_results::Owned>;
    pub type MakeChainParams =
        ::capnp::capability::Params<crate::init_capnp::init::make_chain_params::Owned>;
    pub type MakeChainResults =
        ::capnp::capability::Results<crate::init_capnp::init::make_chain_results::Owned>;
    ...
    impl Client {
        pub fn construct_request(
            ...
            crate::init_capnp::init::construct_params::Owned,
            crate::init_capnp::init::construct_results::Owned,
        > {
            self.client
        ...
        pub fn make_echo_request(
            ...
            crate::init_capnp::init::make_echo_params::Owned,
            crate::init_capnp::init::make_echo_results::Owned,
        > {
            self.client
                .new_call(_private::TYPE_ID, 1, ::core::option::Option::None)
        }
        pub fn make_mining_request(
            &self,
        ) -> ::capnp::capability::Request<
            crate::init_capnp::init::make_mining_params::Owned,
            crate::init_capnp::init::make_mining_results::Owned,
        > {
            self.client
                .new_call(_private::TYPE_ID, 2, ::core::option::Option::None)
        }
        pub fn make_chain_request(
            &self,
        ) -> ::capnp::capability::Request<
            crate::init_capnp::init::make_chain_params::Owned,
            crate::init_capnp::init::make_chain_results::Owned,
        > {
            self.client
    ...
    pub trait Server {
        fn construct(
            ...
            ::capnp::capability::Promise::err(::capnp::Error::unimplemented(
                "method init::Server::construct not implemented".to_string(),
            ))
        }
        fn make_echo(
            &mut self,
            ...
            ::capnp::capability::Promise::err(::capnp::Error::unimplemented(
                "method init::Server::make_echo not implemented".to_string(),
            ))
        }
        fn make_mining(
            &mut self,
            ...
            ::capnp::capability::Promise::err(::capnp::Error::unimplemented(
                "method init::Server::make_mining not implemented".to_string(),
            ))
        }
        fn make_chain(
            &mut self,
            ...
            ::capnp::capability::Promise::err(::capnp::Error::unimplemented(
                "method init::Server::make_chain not implemented".to_string(),
            ))
        }
    }
