...
pub struct RpcServerImpl {
    ...
    stratum_connection_mapping: Arc<RwLock<stratum::ConnectionMapping>>,
...
pub async fn test_extend_rpc() {
    ...
    let _ = run_rpc_server(
        ...
        Arc::new(RwLock::new(stratum::ConnectionMapping::new())),
...
pub async fn test_get_miner_info_rpc() {
    ...
    let stratum_map = Arc::new(RwLock::new(stratum::ConnectionMapping::new()));
    {
