  ...
  return (
    <footer className=" text-gray-300 px-6 sm:px-10 md:px-20 py-8 ml-80">
      ...
      >
        ...
        >
          <h2 className="text-base font-semibold text-white mb-2">Project</h2>
        ...
        >
          <h2 className="text-base font-semibold text-white mb-2">Community</h2>
        ...
        >
          <h2 className="text-base font-semibold text-white mb-2">Legal</h2>
          <ul className="space-y-1 text-sm">
            {[
              ['MIT License', '/license'],
              ['Terms of Use', '/terms'],
