...
export default function BeadRow({
  ...
  return (
    <div className="border-b border-border/80">
      <div
        className="grid max-md:grid-cols-3 md:grid-cols-5 gap-2 p-4 cursor-pointer hover:bg-surfaceHover transition-colors"
      ...
      {bead.parents?.length > 0 && (
        <div className="pl-4 sm:pl-10 pr-4 py-2 bg-surfaceHover border-t border-b border-border/50 overflow-x-auto">
