        ...
        >
          {TrendsTABS.map((tab) => (
            <button
              ...
              className="group inline-flex items-center gap-2 whitespace-nowrap py-3 px-1 border-b-2 font-medium text-sm transition-all duration-200 hover:opacity-80"
            >
              <tab.icon
                style={{
                  color:
