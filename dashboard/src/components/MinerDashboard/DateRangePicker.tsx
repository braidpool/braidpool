  ...
  return (
    <div className="relative">
      ...
      >
        ...
        <span>{TIME_RANGES.find((r) => r.value === timeRange)?.label || "Custom Range"}</span>
              ...
              {TIME_RANGES.map((range) => (
                <button
                  ...
                  className={`w-full text-left px-3 py-2 rounded-md text-sm ${
                    timeRange === range.value ? "bg-blue-600/30 text-blue-200" : "text-gray-300 hover:bg-gray-800/50"
                  }`}
