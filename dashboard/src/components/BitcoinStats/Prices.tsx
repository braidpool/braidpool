  ...
  return (
    <div className="p-4 w-full">
      ...
      <div className="mb-8">
        ...
        <p className="text-xs text-gray-400 mb-4">Market sentiment</p>
        <div className="max-w-xs border border-gray-200 dark:border-gray-700 rounded-xl overflow-hidden">
          <img
