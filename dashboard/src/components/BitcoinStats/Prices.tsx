                    ...
                    <>
                        <div className="flex flex-col">
                            <div className="flex items-center gap-2">
                                ...
                                >
                                    {priceData.currencySymbol}{formatPrice(priceData.current)}
                                </Typography>
                                {priceDirection === 'up' && <ArrowUpward className="text-green-500" fontSize="small" />}
                                {priceDirection === 'down' && <ArrowDownward className="text-red-500" fontSize="small" />}
                            </div>
                        ...
                        <div className="flex flex-col">
                            <Typography variant="body1">
                                {priceData.currencySymbol}{formatPrice(priceData.high24h)}
                            </Typography>
                            <Typography variant="caption" className="text-gray-500">
                                24H High
                            </Typography>
                        ...
                        <div className="flex flex-col">
                            <Typography variant="body1">
                                {priceData.currencySymbol}{formatPrice(priceData.low24h)}
                            </Typography>
                            <Typography variant="caption" className="text-gray-500">
                                24H Low
                            </Typography>
                ...
                <div className="grid sm:grid-cols-1 md:grid-cols-2 gap-4 md:gap-20 p-4">
                    ...
                    <div className="flex flex-col w-full h-72">
                        ...
                        <Typography variant="caption" className="text-gray-500 mb-2">
                            Displays the low, current, and high prices of Bitcoin in the selected currency over the past 24 hours.
                        </Typography>
                    ...
                    <div className="flex flex-col w-full h-72">
                        ...
                        <ResponsiveContainer width="100%" height="100%">
                            ...
                            >
                                ...
                                />
                                <Tooltip
                                    contentStyle={{ backgroundColor: 'black', border: '1px solid #ccc' }}
                                    formatter={(value) => [`${getCurrencySymbol(currency)}${formatPrice(Number(value))}`, "Price"]}
                    ...
                    <div className="flex flex-col w-full h-72">
                        ...
                        <div className="w-full flex flex-wrap justify-center items-center" >
                            <ResponsiveContainer width="50%" height="100%">
                                <img className='bg-blend-multiply' src="https://alternative.me/crypto/fear-and-greed-index.png" alt="Latest Crypto Fear & Greed Index" />
