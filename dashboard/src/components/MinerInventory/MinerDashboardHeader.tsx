...
const MinerDashboardHeader: React.FC<MinerDashboardHeaderProps> = ({
  ...
  <div className="grid grid-cols-2 lg:grid-cols-4 gap-5 text-sm max-w-4xl mx-auto">
    <div className="px-2 py-1 rounded-md border border-border  text-textSecondary text-center">
      <div className="font-medium text-sm">Total Miners</div>
      <div className="text-sm text-textPrimary mt-1">{totalMiners}</div>
    </div>
    <div className="px-2 py-1 rounded-md border border-border text-textSecondary text-center">
    ...
    <div className="px-2 py-1 rounded-md border border-border text-textSecondary text-center">
      ...
      <div className="text-sm text-textPrimary mt-1">{totalPower}W</div>
    </div>
    <div className="px-2 py-1 rounded-md border border-border text-textSecondary text-center">
