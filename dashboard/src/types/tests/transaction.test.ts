...
describe('Transaction Types - Basic Tests', () => {
    ...
    describe('Category Descriptions', () => {
        it('has descriptions for all categories', () => {
            expect(TRANSACTION_CATEGORY_DESCRIPTIONS[TransactionCategory.MEMPOOL]).toContain('mempool');
            expect(TRANSACTION_CATEGORY_DESCRIPTIONS[TransactionCategory.CONFIRMED]).toContain('confirmed');
        });
